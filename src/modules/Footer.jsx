  ...
  return (
    ...
    <div className="container footer__container">
      <a className="footer__logo-link">
        <img src="image/logo.svg" alt="логотип Cuo Time" className="footer__logo"/>
      </a>
      ...
      <div className="footer__info">
        ...
        <ul className="footer__developers">
          ...
          <li className="footer__developer">Developer:
            <a href="https://github.com/StepanIT" target="_blank" className="footer__developer-link">Stepan Rudakov</a>
          </li>
        </ul>
      </div>
  
      <div className="footer__contacts">
        <a href="malito:CUPTIME@gmail.com" className="footer__email">CUPTIME@gmail.com</a>
